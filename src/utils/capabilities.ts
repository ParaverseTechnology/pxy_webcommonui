class Capabilities {
    ...
    static get isIOSSafari() {
        return Capabilities.$isIOSSafari;
    }
}
...
const testQQ = function() {
    const ua = navigator.userAgent.toLowerCase();
    return ua.indexOf('mqqbrowser') > -1;
}

const testIOSSafari = function() {
...
Capabilities.$isQQ = testQQ();
Capabilities.$isIOSSafari = testIOSSafari();
